...
class CHIRAGEnv:
    ...
    def step(self, action: int) -> Tuple[Dict[str, Any], float, bool, bool, Dict]:
        ...
        reward, correct = self._compute_reward(action, answer_found, ground_truth, difficulty)
    ...
    def render(self, mode: str = "human") -> None:
        print(f"Step {self._episode_step} | Q: {self._last_question} | R: {self._last_reward}")
